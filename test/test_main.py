...
from methane_super_emitters.model import SuperEmitterDetector, SuperEmitterLocator
...
def test_locator():
    model = SuperEmitterLocator(fields=["methane", "qa", "u10", "v10"])
    datamodule = TROPOMISuperEmitterDataModule(
        "./data/dataset", fields=["methane", "qa", "u10", "v10"]
    )
